...
var ConfiguredComponent = React.createClass({
    propTypes: {
    ...
    render: function () {
       ...
       return connectDragSource(connectDropTarget(
           <div className="panel-container" style={{ opacity }}>
              <div className="uk-flex-center uk-flex-top uk-text-center uk-panel uk-panel-box">
...
module.exports = DragSource(ItemTypes.CONFIGURED_COMPONENT, componentSource, collect)(DropTarget(ItemTypes.CONFIGURED_COMPONENT,cardTarget, collectTarget)(ConfiguredComponent));